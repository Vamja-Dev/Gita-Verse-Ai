  ...
  export default function ChatBox({ onSend, onNavigate }) {
    ...
    return (
      <div className="w-full relative flex flex-col items-center">
        ...
        <div className="w-full flex justify-center z-30 mt-5 md:mt-2 px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, scale: 0.97 }}
            animate={{ opacity: 1, scale: 1 }}
        ...
        {/* --- EXACT ABSOLUTE RESPONSE CONTAINER WITH RESPONSIVE PADDING & WIDTH FIXES --- */}
        <div className="absolute top-[175px] left-1/2 -translate-x-1/2 w-full max-w-5xl px-4 sm:px-6 pb-24 z-20 pointer-events-none">
            ...
            <AnimatePresence>
              {responseResult && (
                <motion.div
                  ...
                  className="w-full bg-[#140b06]/95 border-2 border-amber-500/40 rounded-3xl p-6 sm:p-8 text-amber-100 shadow-2xl backdrop-blur-xl font-serif space-y-6"
                >
                  {responseResult.success ? (
                    <>
                      ...
                      <div className="bg-[#1f1108] p-3 rounded-2xl border border-amber-500/30 text-center space-y-3 shadow-md">
