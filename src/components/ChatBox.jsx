...
export default function ChatBox({ onSend }) {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center space-y-8 pb-24">
      {/* Input Chat Box */}
      <motion.div
      ...
      {/* --- FULL-WIDTH STACKED SCROLL LAYOUT --- */}
      <AnimatePresence mode="wait">
        {responseResult && (
          <motion.div 
            ...
            className="w-full max-w-5xl bg-[#140b06]/95 border-2 border-amber-500/40 rounded-3xl p-8 text-amber-100 shadow-2xl backdrop-blur-xl font-serif space-y-6"
          >
            {responseResult.success ? (
              <>
                ...
                {/* ROW 3: Translations Section (Vertically Stacked) */}
                ...
                {/* ROW 4: Explanations Section (Vertically Stacked) */}
                <div className="bg-slate-950/50 p-6 rounded-2xl border border-amber-500/20 space-y-3">
                ...
                {/* ROW 5: The Grand Finale - Spiritual Connection (English Only) */}
              ...
              /* Graceful validation block for non-life problems or gibberish inputs */
